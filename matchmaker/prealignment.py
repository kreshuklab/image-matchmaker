...
def get_SVD_transform(img, spacing, save_path=None):
    ...
    Args:
        img: Input image volume.
        spacing: Voxel spacing of the image.
        save_path: Path to save the plot of original and rotated point clouds. Defaults to None.

    Returns:
        Tuple containing the center of gravity and the principal axes matrix.
    """
