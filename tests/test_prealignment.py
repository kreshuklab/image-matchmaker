...
from matchmaker.prealignment import main
...
def test_prealignment():
    ...
    input_key = config["keys"]["n5"]
    output_key = config["keys"]["prealignment"]
    ...
    output_transform_path = f"{output_dir}/{output_key}_transform.json"
    ...
    read_volume(fixed_path, output_key)
