...
datasets of different modalities (e.g. EM ↔ LM). It optimizes a transformation that maps a
...
3. **Coherent Point Drift (CPD)** — non-rigid alignment of instance-centroid point clouds (via *probreg*).
4. **Instance matching** — establish instance correspondences (`hungarian` / `ilp` / `sinkhorn`).
